...
techStack:
  sections:
    - title: Frontend
      items:
        - name: HTML
          description: Semantic, accessibility-aware markup across core portfolio sections.
        - name: SCSS/Sass
          description: Modular styling system with variables, partials, and a compiled main stylesheet.
        - name: Vanilla JavaScript
          description: Client-side interactions including section reveal animation, typewriter text, and mobile navigation toggle.
        - name: Font Awesome (CDN)
          description: Iconography delivered through a lightweight CDN integration.
highlights:
...
links:
  - label: Live Site
    url: https://jpdavalos423.github.io/portfolio-website-1.0/
  - label: GitHub Repo
